...
public class EnemyVehicleMovementControllerOLD : MonoBehaviour
{
    ...
    //    InvokeRepeating(nameof(ChangeSlideOffset), 0, GameConfig.Instance.ChangeDestinationDelay);
    ...
    //    while (t <= 1)
    //    {
    //        t += Time.deltaTime / (GameConfig.Instance.ChangeDestinationDelay);
    ...
    //        transform.Translate(mod * GameConfig.Instance.SpeedMod * InRaidManager.Instance.PlayerMoveSpeed * Time.deltaTime * Vector3.left, Space.World);
    //        yield return null;
    //    }
    ...
    //    {
    //        transform.Translate(GameConfig.Instance.SpeedMod * InRaidManager.Instance.PlayerMoveSpeed * runSpeedMod * Time.deltaTime * Vector3.right, Space.World);
    //        yield return null;
    //    }
    //    //InRaidManager.Instance.OnEnemyObjectDestroyed(_enemyVehicleManager);
    //    InRaidManager.Instance.OnEnemyEscaped();
    //    Destroy(gameObject);
    //}
