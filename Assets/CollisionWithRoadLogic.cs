...
public class CollisionWithRoadLogic : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        _RB.AddForceAtPosition(GameConfig.Instance.TouchRoadImpulseMod * RaidObjectsManager.Instance.PlayerMoveSpeed * Vector3.up, collision.GetContact(0).point, ForceMode.Impulse);
    }
}
