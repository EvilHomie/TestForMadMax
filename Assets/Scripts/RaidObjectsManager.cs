...
public class RaidObjectsManager : MonoBehaviour
{
    public static RaidObjectsManager Instance;
    ...
    public void ChangeSpeedOnStartRaid(float speed, float reachSpeedDuration)
    {
        StartCoroutine(StartLerpSpeed(speed, reachSpeedDuration));
    }
    ...
    IEnumerator StartLerpSpeed(float speed, float reachSpeedDuration)
    {
        float t = 0;
        while (t <= 1)
        {
